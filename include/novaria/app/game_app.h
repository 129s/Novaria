...
private:
    ...
    std::unique_ptr<world::IWorldService> world_service_;
    std::unique_ptr<net::INetService> net_service_;
    std::unique_ptr<script::IScriptHost> script_host_;
    std::unique_ptr<sim::SimulationKernel> simulation_kernel_;
