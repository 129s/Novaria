...
platform::RenderScene RenderSceneBuilder::Build(
    ...
    scene.target_highlight_visible = player_state.target_highlight_visible;
    scene.target_highlight_tile_x = player_state.target_highlight_tile_x;
    scene.target_highlight_tile_y = player_state.target_highlight_tile_y;
    scene.hud = platform::RenderHudState{
        ...
        .pickup_event_counter = player_state.pickup_event_counter,
